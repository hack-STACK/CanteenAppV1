...
class _StallInfoSectionState extends State<StallInfoSection> with SingleTickerProviderStateMixin {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (widget.stall.description != null && widget.stall.description!.isNotEmpty)
            Container(
              width: double.infinity,
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: (isOpen ? Colors.green[500] : Colors.red[500])!.withOpacity(0.4),
                  blurRadius: 4,
                  spreadRadius: 1,
                ),
              ],
  ...
  Widget _buildEnhancedMetricsRow() {
    return Container(
      ...
      child: Row(
        ...
        children: widget.metrics.map((metric) => _buildEnhancedMetricItem(metric)).toList(),
      ),
    );
  }
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            content: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _buildInfoRow('Category', widget.stall.stanName.split(' ').first),
          ...
          _buildInfoCard(
            ...
            content: Row(
              children: [
                _buildPopularItem('Nasi Goreng', '25K+', 'assets/icons/fried-rice.png'),
                const SizedBox(width: 16),
                _buildPopularItem('Es Teh', '18K+', 'assets/icons/iced-tea.png'),
              ],
            ),
          ),
        ],
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    isOpen ? 'Closes in $remainingTime' : 'Opens tomorrow',
                    style: TextStyle(
                      fontSize: 13,
                      color: isOpen ? Colors.green[700] : Colors.red[700],
                    ),
          ...
          child: Column(
            children: [
              ...
              ...schedules.map((entry) {
                ...
                return Container(
                  decoration: BoxDecoration(
                    color: isToday ? colorScheme.primary.withOpacity(0.04) : null,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(
                            fontWeight: FontWeight.w500,
                            color: isToday ? colorScheme.primary : Colors.grey[800],
                          ),
                        ),
                      ),
                    ],
  ...
  Widget _buildPaymentsTab() {
    return ListView(
      ...
      children: [
        ...
        ...widget.paymentMethods.map((method) => _buildPaymentMethodCard(method)),
